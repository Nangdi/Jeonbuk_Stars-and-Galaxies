...
namespace Runtime2DTransformInteractor
{
    ...
    public class TransformInteractor : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (!TransformInteractorController.instance)
            {
                return;
            }
        ...
        private void OnMouseExit()
        {
            ...
            if (!selected)
            {
                ...
                Collider2D colliderHit = Physics2D.OverlapPoint(TransformInteractorController.instance.mainCamera.ScreenToWorldPoint(Input.mousePosition));
                if (!colliderHit ||
        ...
        private void OnMouseDown()
        {
            ...
            lastMousePosition = TransformInteractorController.instance.mainCamera.ScreenToWorldPoint(Input.mousePosition);
        }
        ...
        private void OnMouseDrag()
        {
            ...
            if (selected)
            {
                Vector2 newPosition = TransformInteractorController.instance.mainCamera.ScreenToWorldPoint(Input.mousePosition);
