...
namespace ShaderCrew.SeeThroughShader
{
    public sealed class PlayersDataStorage
    {
        ...
        public void GeneratePlayerDataForAllPlayerPositions()
        {
            ...
            int arrayLength = (int)Shader.GetGlobalFloat("_ArrayLength");
            Debug.Assert(playerPosArray != null && playerPosArray.Length > 0, "PlayerPosArray is null or empty");
            Debug.Assert(_PlayerDataDict.Count <= 0, "PlayerData for all player positions have already been generated.");
            Debug.Assert(arrayLength > 0, "Shader _ArrayLength is 0 or less.");
